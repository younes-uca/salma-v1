package ma.sir.hr.zynerator.converter;


import ma.sir.hr.zynerator.bean.Etablissement;
import ma.sir.hr.zynerator.dto.EtablissementDto;

import ma.sir.hr.zynerator.util.ListUtil;
import ma.sir.hr.zynerator.audit.AuditBusinessObject;
import ma.sir.hr.zynerator.bean.BusinessObject;
import ma.sir.hr.zynerator.dto.AuditBaseDto;
import ma.sir.hr.zynerator.dto.BaseDto;
import ma.sir.hr.zynerator.util.DateUtil;
import ma.sir.hr.zynerator.util.RefelexivityUtil;
import ma.sir.hr.zynerator.util.StringUtil;
import ma.sir.hr.zynerator.util.Utils;
