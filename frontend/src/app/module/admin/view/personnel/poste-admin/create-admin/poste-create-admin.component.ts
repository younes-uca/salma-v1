...
@Component({
  selector: 'app-poste-create-admin',
  templateUrl: './poste-create-admin.component.html'
})
export class PosteCreateAdminComponent extends AbstractCreateController<PosteDto, PosteCriteria, PosteService>  implements OnInit {
